...
#include "PointerAnalysis/LLVMPointerAnalysisOptions.h"
#include "DataDependence/DataDependence.h"
#include "DataDependence/LLVMDataDependenceAnalysisOptions.h"
#include "ControlDependence/ControlDependence.h"
#include "ControlDependence/LLVMControlDependenceAnalysisOptions.h"

#include "PointerAnalysis/PointerAnalysis.h"
#ifdef HAVE_SVF
#include "PointerAnalysis/SVFPointerAnalysis.h"
#endif
#include "../PointerAnalysis/PointerAnalysisFI.h"
#include "../PointerAnalysis/PointerAnalysisFS.h"
#include "../PointerAnalysis/PointerAnalysisFSInv.h"
#include "../PointerAnalysis/Pointer.h"
#include "../Offset.h"

#include "ThreadRegions/include/Graphs/ControlFlowGraph.h"
...
public:
    ...
    : _M(M), _options(opts),
      ...
      _entryFunction(M->getFunction(_options.entryFunction)) {
        errs() <<"ENTRY_FUNCTION!!\t" << _options.entryFunction <<"\n";
